...
private void initComponents(){
    ...
    logPan.setLayout(new GridBagLayout());
     GridBagConstraints wtf=new GridBagConstraints();
         ...
         wtf.weightx=30;
         wtf.ipady=10;
    enter.addActionListener((java.awt.event.ActionEvent evt) -> {
...
add(logPan);
        ...
        /**
      * Имя пользователя "serv" - запускается сервер
      * Имя пользователя "exit" - закрывается программа
      * другое - загружается клиент с соотв. именем
     * @param args
     */
